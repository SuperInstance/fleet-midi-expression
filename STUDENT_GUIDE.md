# Student Guide: fleet-midi-expression

_Learn how the expression agent works and how to use it._

---

## What You'll Learn

1. What the expression musical concept is
2. How ternary decomposition applies to expression
...
```bash
curl -s http://localhost:2165/health | python3 -m json.tool
```
...
```bash
curl -s -X POST http://localhost:2165/agent \
